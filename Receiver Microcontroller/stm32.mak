...
#Additional flags
PREPROCESSOR_MACROS += ARM_MATH_CM7 STM32F746NG LWIP_IPV4 stm32_flash_layout STM32F746xx
INCLUDE_DIRS += . $(BSP_ROOT)/FreeRTOS/Source/CMSIS_RTOS $(BSP_ROOT)/FreeRTOS/Source/Include $(BSP_ROOT)/FreeRTOS/Source/Portable/gcc/ARM_CM3 $(BSP_ROOT)/LwIP/src/include $(BSP_ROOT)/LwIP/system $(BSP_ROOT)/LwIP/src/include/ipv4 $(BSP_ROOT)/STM32F7xxxx/STM32F7xx_HAL_Driver/Inc $(BSP_ROOT)/STM32F7xxxx/STM32F7xx_HAL_Driver/Inc/Legacy $(BSP_ROOT)/STM32F7xxxx/CMSIS_HAL/Device/ST/STM32F7xx/Include $(BSP_ROOT)/STM32F7xxxx/CMSIS_HAL/Include $(BSP_ROOT)/STM32F7xxxx/CMSIS_HAL/RTOS/Template $(BSP_ROOT)/STM32F7xxxx/BSP/STM32746G-Discovery
LIBRARY_DIRS += 
